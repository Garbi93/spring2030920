...
public class Controller24 {
    ...
    public void method2 (MyDto17Supplier supplier) throws SQLException {
        ...
        try(connection; statement) {
            ...
            int i = statement.executeUpdate();// DML
                ...
                if(i == 1) {
                    System.out.println("데이터 잘 들어감!!!!!!!!!!!!!");
                }else {
                    System.out.println("데이터 잘 못 들어감############");
                }
    ...
    @PostMapping("sub4")
    public void method411(MyDto18Employee employee) throws SQLException {
        String sql = """
        ...
        try(connection; statement) {
            ...
            if(count == 1) {
                System.out.println("데이터가 잘 등록 되었습니다.");
            }else {
