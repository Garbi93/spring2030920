...
public class Controller38 {
    ...
    @GetMapping("sub1")
    @ResponseBody
    // 응답을 jsp로 리턴 하지 말고 // 응답자체로 봐라 라는 어노테이션
    ...
    public Map<String, Object> method4() {
        ...
        //  "birth":"1999-03-03"}
        return Map.of("city","seoul","price",3000, "birth","1999-03-01","list",List.of("son","lee","kim"));
    ...
    unit(단위)
     */
    // 7번째 메소드와 45번 dto를 사용하여 dao에 메소드selectByProductId2로 만들어라
    @GetMapping("sub7")
    @ResponseBody
