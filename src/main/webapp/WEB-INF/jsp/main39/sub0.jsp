    ...
    <script>
        function ajax2() {
            axios.get("/main39/sub2")
                .then(()=> console.log("성공"))
                .catch(() => console.log("실패")) // 이게 실행 되게 메소드 작성
        }
    </script>
</div>
...
<div>
    ...
    <script>
        function ajax4() {
            ...
            // 400번대 응답이면 #result1요소에 잘못된 요청 출력
            // 500 번대 응답이면 #result1 요소에 서버에러 출력
        }
    </script>
</div>
...
<div>
    ...
    <div>
        <textarea id="noteTextArea" cols="30" rows="10" placeholder="notes"></textarea>
    </div>
    <div>
